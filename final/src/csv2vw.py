...
print("Events..")
with open("data/events.csv") as infile:
...
csv_to_vw(loc_csv='data/clicks_train.csv', loc_output='train.w', train=True)
csv_to_vw(loc_csv='data/clicks_test.csv', loc_output='test.w', train=False)
